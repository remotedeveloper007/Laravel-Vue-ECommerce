...
<template>
  <div>
    <ul class="breadcrumb icon breadcrumb-item">
      <li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="/assets/admin/default/photo1.png" alt="Photo" />
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img
                                ...
                                src="/assets/admin/default/photo2.png"
                                alt="Photo"
                              />
                              <img
                                class="img-fluid"
                                src="/assets/admin/default/photo3.jpg"
                                alt="Photo"
                              />
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img
                                class="img-fluid mb-3"
                                src="/assets/admin/default/photo4.jpg"
                                alt="Photo"
                              />
                              <img
                                class="img-fluid"
                                src="/assets/admin/default/photo1.png"
                                alt="Photo"
                              />
                            </div>
                            <!-- /.col -->
...
export default {
  ...
  mounted() {
    axios.get("/admin/details").then((response) => {
        this.form.fill(response.data.admin)
    });      
  },
  computed: {},
  methods: {},
