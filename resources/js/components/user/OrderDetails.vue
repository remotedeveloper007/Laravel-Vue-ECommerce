            ...
            <h1>Profile</h1>
              ...
              <div class="col-sm-12">
                <ol id="breadcrumb" class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a :to="{ name: 'dashboard' }">User Profile</a></li>&nbsp;
                      ...
                      <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <tr v-for="pro in order.orders" :key="pro.id">
                            ...
                            <td><img :src="`/product_image/${pro.image}`" width="70" alt="" /></td>
                            <td>{{pro.product_name}}<p>{{pro.product_code}}</p></td>
                            <td>{{pro.product_size	}}</td>
                            <td>{{pro.color}}</td>
                            <td>{{pro.product_price | toCurrency}}</td>
                            <td>{{pro.quantity}}</td>
                            <td>{{pro.discount | toCurrency}}</td>                                  
                          </tr>
                        </tbody>
                        <tfoot>
                          <tr>
